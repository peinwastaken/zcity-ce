...
function SWEP:DoRT()
	...
	local optic
	local _, foundatt = self:HasAttachment("sight", "optic")
	...
	local _, point = util.DistanceToLine(view.origin, view.origin + ang:Forward() * 50, pos)
...
CreateMaterial( "example_rt_mat", "UnlitGeneric", {
