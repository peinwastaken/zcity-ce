...
SWEP.AdminOnly = true
SWEP.PrintName = "base_hg_shotgun"
SWEP.Author = "Z-City"
SWEP.Instructions = "Shared base for tube-fed and manual-cycle ranged weapons"
SWEP.Category = "Other"
SWEP.IsHomigradShotgunBase = true
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
...
function SWEP:AnimHoldPost(model)
	if not self.LeftFingerPose then return end

	for bone, ang in pairs(self.LeftFingerPose) do
		self:BoneSet(bone, vector_zero, ang)
	end
end
