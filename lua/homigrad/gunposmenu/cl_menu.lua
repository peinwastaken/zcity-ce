...
local function CreateOptionsMenu()
    ...
    DermaNumSlider:SetConVar( "zc_gunorigin_x" )
    ...
    DermaNumSlider:SetMax( 4 )
    DermaNumSlider:SetDecimals( 2 )
    DermaNumSlider:SetConVar( "zc_gunorigin_y" )
    DermaNumSlider:SizeToContents()
    ...
    DermaNumSlider:SetMax( 4 )
    DermaNumSlider:SetDecimals( 2 )
    DermaNumSlider:SetConVar( "zc_gunorigin_z" )
    DermaNumSlider:SizeToContents()
--[[
    local DLabel = vgui.Create( "DLabel", DScrollPanel )
    DLabel:Dock(TOP)
    ...
    DermaNumSlider:SetDecimals( 2 )
    DermaNumSlider:SetConVar( "zc_gunangle_p" )
    DermaNumSlider:SizeToContents()
    ...
    DermaNumSlider:SetMax( 20 )
    DermaNumSlider:SetDecimals( 2 )
    DermaNumSlider:SetConVar( "zc_gunangle_y" )
    DermaNumSlider:SizeToContents()
    ...
    DermaNumSlider:SetMax( 20 )
    DermaNumSlider:SetDecimals( 2 )
    DermaNumSlider:SetConVar( "zc_gunangle_r" )
    DermaNumSlider:SizeToContents()--]]
end
