zc.settings = zc.settings or {}
zc.settings.tbl = zc.settings.tbl or {}
...
function zc.settings:AddOpt( strCategory, strConVar, strTitle, bDecimals, bString, category, desc )
...
zc.settings:AddOpt("settings/category/gameplay","zc_old_notificate", "settings/gameplay/old_notifications")
zc.settings:AddOpt("settings/category/gameplay","zc_cheats", "settings/gameplay/enable_cheats")
zc.settings:AddOpt("settings/category/gameplay","zc_showthoughts", "settings/gameplay/show_thoughts")
zc.settings:AddOpt("settings/category/gameplay","zc_hints", "settings/gameplay/show_hints")
zc.settings:AddOpt("settings/category/gameplay","zc_gary", "settings/gameplay/hg_gary")
zc.settings:AddOpt("settings/category/gameplay","zc_deathfadeout", "settings/gameplay/death_fade_out")
--zc_gary
--zc_deathfadeout
if not game.IsDedicated() and LocalPlayer():IsAdmin() then
    zc.settings:AddOpt("menu/settings/serversettings", "zc_always_ragdoll_aim", "menu/settings/aim_in_ragdoll", nil, nil, "bool", "menu/settings/aim_in_ragdoll/desc")
	zc.settings:AddOpt("menu/settings/serversettings", "zc_toughnpcs", "settings/server/tough_npcs")
	zc.settings:AddOpt("menu/settings/serversettings", "zc_thirdperson", "settings/server/thirdperson")
    zc.settings:AddOpt("menu/settings/serversettings", "zc_legacycam", "settings/server/legacy_camera")
    zc.settings:AddOpt("menu/settings/serversettings", "zc_ragdollcombat", "settings/server/ragdoll_combat")
    zc.settings:AddOpt("menu/settings/serversettings", "zc_movement_stamina_debuff", "settings/server/movement_stamina_debuff")
    zc.settings:AddOpt("menu/settings/serversettings", "zc_appearance_access_for_all", "settings/server/appearance_full_access", nil, nil, "bool")
	zc.settings:AddOpt("menu/settings/serversettings", "zc_healanims", "settings/server/heal_food_animations")
	zc.settings:AddOpt("menu/settings/serversettings", "zc_aimtoshoot", "settings/server/aim_to_shoot")
	zc.settings:AddOpt("menu/settings/serversettings", "zc_slings", "settings/server/sling_system")
    zc.settings:AddOpt("menu/settings/serversettings", "zc_homicide_traitoramount", "settings/server/homicide_traitor_amount", nil, nil, "int")
end
--zc_appearance_access_for_all
--zc_legacycam
--zc_toughnpcs

zc.settings:AddOpt("settings/category/debug","zc_show_hitposmuzzle", "settings/debug/show_weapon_hitpos")
zc.settings:AddOpt("settings/category/debug","zc_setzoompos", "settings/debug/edit_weapon_zoompos")
zc.settings:AddOpt("settings/category/debug","zc_show_hitbox", "settings/debug/show_hitboxes")

zc.settings:AddOpt("settings/category/optimization","zc_potatopc", "settings/optimization/potato_pc")
zc.settings:AddOpt("settings/category/optimization","zc_anims_draw_distance", "settings/optimization/animations_draw_distance", true, nil, "int")
zc.settings:AddOpt("settings/category/optimization","zc_anim_fps", "settings/optimization/animations_fps", nil, nil, "int")
zc.settings:AddOpt("settings/category/optimization","zc_attachment_draw_distance", "settings/optimization/attachment_draw_distance", true, nil, "int")
zc.settings:AddOpt("settings/category/optimization","zc_maxsmoketrails", "settings/optimization/maximum_smoke_trails", nil, nil, "int")
zc.settings:AddOpt("settings/category/optimization","zc_tpik_distance", "settings/optimization/tpik_render_distance", true, nil, "int")

zc.settings:AddOpt("settings/category/blood","zc_blood_draw_distance", "settings/blood/draw_distance")
zc.settings:AddOpt("settings/category/blood","zc_blood_fps", "settings/blood/fps")
zc.settings:AddOpt("settings/category/blood","zc_blood_sprites", "settings/blood/sprites")
zc.settings:AddOpt("settings/category/blood","zc_old_blood", "settings/blood/old_blood")

zc.settings:AddOpt("settings/category/ui", "zc_font", "settings/ui/change_custom_font", false, true)
zc.settings:AddOpt("settings/category/ui", "zc_language", "settings/ui/change_language", false, true)

zc.settings:AddOpt("settings/category/weapons","zc_weaponshotblur_enable", "settings/weapons/shooting_blur")
zc.settings:AddOpt("settings/category/weapons","zc_dynamic_mags", "settings/weapons/dynamic_ammo_inspect")
zc.settings:AddOpt("settings/category/weapons","zc_zoomsensitivity", "settings/weapons/scope_sensitivity")
zc.settings:AddOpt("settings/category/weapons","zc_highpitchgunfire", "settings/weapons/high_pitch_gunfire")

zc.settings:AddOpt("settings/category/view","zc_firstperson_death", "settings/view/first_person_death")
zc.settings:AddOpt("settings/category/view","zc_fov", "settings/view/field_of_view")
zc.settings:AddOpt("settings/category/view","zc_newspectate", "settings/view/smooth_spectator_camera")
zc.settings:AddOpt("settings/category/view","zc_cshs_fake", "settings/view/cshs_ragdoll_camera")
zc.settings:AddOpt("settings/category/view","zc_gun_cam", "settings/view/gun_camera_admin")
zc.settings:AddOpt("settings/category/view","zc_nofovzoom", "settings/view/fov_zoom")
zc.settings:AddOpt("settings/category/view","zc_realismcam", "settings/view/realism_camera")
zc.settings:AddOpt("settings/category/view","zc_gopro", "settings/view/gopro_camera")
zc.settings:AddOpt("settings/category/view","zc_newfakecam", "settings/view/new_fake_camera")
zc.settings:AddOpt("settings/category/view","zc_leancam_mul", "settings/view/lean_camera_mul", true, nil, "int")
zc.settings:AddOpt("settings/category/view","zc_gun_cam", "settings/view/gun_camera_wip_admin")
--zc_hints
--zc_leancam_mul
  --zc_newfakecam
zc.settings:AddOpt("settings/category/sound","zc_dmusic", "settings/sound/dynamic_music")
zc.settings:AddOpt("settings/category/sound","zc_quietshots", "settings/sound/quiet_shots")


function zc.CreateCategory(ctgName, ParentPanel, yPos)
    local pppanel = vgui.Create('DPanel', ParentPanel)
    local label = zc.locale.GetLocalized(ctgName)
...
function zc.GetConVarType(convar)
...
function zc.CreateButton(buttonData, convarName, ParentPanel, yPos)
    ...
    local localizedLabel = zc.locale.GetLocalized(label)
    local localizedDesc = zc.locale.GetLocalized(desc)
    ...
    convarType = buttonData[6] or zc.GetConVarType(convar)
    pppanel.Paint = function(self,w,h)
    ...
    if convarName == "zc_language" then
        ...
        local options = zc.locale.GetLocaleNativeNames()
...
function zc.DrawSettings(ParentPanel)
    local sidePanel = zc.CreateSidePanel(ParentPanel)

    // create category panels
    local categoryPanels = {}
    for categoryName, categoryTable in pairs(zc.settings.tbl) do
        local categoryPanel = vgui.Create("DPanel", sidePanel)
        categoryPanel:SetWide(sidePanel:GetWide())
        categoryPanel.Paint = function() end

        local categoryHeading = zc.CreateCategory(categoryName, categoryPanel, offset)
        ...
        for convarName, settingData in pairs(categoryTable) do
            local option = zc.CreateButton(settingData, convarName, sidePanel, yOffset)
...
function zc.CreateBindRow(bindId, bindData, ParentPanel, yPos)
    local pppanel = vgui.Create('DPanel', ParentPanel)
    pppanel:SetSize(ParentPanel:GetWide()/1.05, 64)
    ...
    pppanel.Paint = function(self,w,h)
        ...
        local label = zc.locale.GetLocalized(bindData.label)
        local desc = zc.locale.GetLocalized(bindData.description)
    ...
    binder.OnChange = function(self, num)
        zc.dev.DevPrint(string.format("New bind for %s -> %s (key: %s)", bindId, num, input.GetKeyName(num or KEY_NONE) or "NONE"))
        zc.binds.UpdateBind(bindId, num)
    end
    ...
    override:SetTooltip(zc.locale.GetLocalized("binds/override/tooltip"))
    ...
    override.OnChange = function(self, new)
        zc.binds.UpdateBindOverride(bindId, new)
        surface.PlaySound('glide/headlights_on.wav')
    end
    override.OnMousePressed = function(self, mouseCode)
        ...
        if mouseCode == MOUSE_MIDDLE and bindData.should_override != default then
            ...
            zc.binds.UpdateBindOverride(bindId, default)
            return
        end
    ...
    overrideLabel:SetText(zc.locale.GetLocalized("binds/override"))
...
function zc.DrawBinds(ParentPanel)
    local sidePanel = zc.CreateSidePanel(ParentPanel)

    // create category panels
    local categoryPanels = {}
    for _, category in ipairs(zc.binds.categories) do
        local categoryPanel = vgui.Create("DPanel", sidePanel)
        categoryPanel:SetWide(sidePanel:GetWide())
        categoryPanel.Paint = function() end

        local categoryHeading = zc.CreateCategory(category.label, categoryPanel, offset)
        categoryHeading:Dock(TOP)
...
function zc.CreateSidePanel(ParentPanel)
