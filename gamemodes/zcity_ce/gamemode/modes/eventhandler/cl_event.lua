...
local function CreateLootPollingMenu()
    ...
    createButton(buttonPanel, 15, 20, 140, 30, "Remove Selected",
    ...
    createButton(buttonPanel, 505, 20, 140, 30, "Reset All",
        Color(180, 10, 10), Color(220, 30, 30),
        function()
    ...
    createButton(buttonPanel, 165, 20, 160, 30, "Select from List",
    ...
    createButton(buttonPanel, 335, 20, 160, 30, "Medical",
